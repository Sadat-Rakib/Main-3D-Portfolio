    ...
    <>
      ...
      <section className="max-container">
        ...
        <div className="py-16">
          ...
          <div className="mt-5 flex flex-col gap-3 text-slate-500">
            <p>
            I've collaborated with leading tech startups and institutions since 2023, enhancing my AI and full-stack skills, driving 2.8x revenue growth, and achieving 95% research quality with top experts. Here's the rundown:
            </p>
          </div>
